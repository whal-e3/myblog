...
categories:
  - wargame
  - writeup
cover: Assets/writeup/easy_unpack/cover.png
publish: true
comments: true
difficulty: easy
series:
...
#### How Packed binary looks like 🕷️`x32dbg`
...
![[스크린샷 2026-02-12 204723.png|400]]
...
![[스크린샷 2026-02-12 204726.png|300]]
...
- After the final `VirtualProtect()` call, the process jmp to `00401150`.
	![[스크린샷 2026-02-12 212129.png|560]]
...
![[스크린샷 2026-02-11 174513.png|350]]
...
- Install MSYS2 for cpp compile.
	![[스크린샷 2026-02-11 171556.png|500]]
...
![[스크린샷 2026-02-12 204726.png|350]]
- Can check that `VirtualProtect()` allows read/write for `00401000 ~ 00405000` && `00406000 ~ 00409000` which are original place of where `easy_unpackme.exe` is.
	![[스크린샷 2026-02-12 215553.png|400]]

2. After final call of `VirtualProtect()`, the process JMP to `00401150`.
	![[스크린샷 2026-02-12 212129.png]]
- `GetVersion()`, `GetCommandLineA()`, `GetStartupInfoA()`...
	- These functions usually runs on a program start-up!

2. The process reaches `00401219` and JMP to `00401000`.
	![[스크린샷 2026-02-12 213821.png]]
- `CreateWindowExA`, `GetMessageA` ...
	- Which are for initializing Windows GUI

2. And after some `f8` blank window pops up.
	![[스크린샷 2026-02-12 212258.png|250]]
